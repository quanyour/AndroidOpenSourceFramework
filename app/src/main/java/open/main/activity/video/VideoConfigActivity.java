 ...
 * 短视频录制 config 界面
 *
 * 该功能参考博客  http://blog.csdn.net/mabeijianxi/article/details/63335722
 */
...
public class VideoConfigActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        et_record_crfSize = (EditText) i_record.findViewById(R.id.et_crfSize);
        ...
        et_compress_crfSize = (EditText) i_compress.findViewById(R.id.et_crfSize);
...
//                        .setVelocity(BaseMediaBitrateConfig.Velocity.ULTRAFAST)
                    ...
                    if (!TextUtils.isEmpty(mime_type) && mime_type.contains("video") && !TextUtils.isEmpty(_data)) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(VideoConfigActivity.this, SendSmallVideoActivity.class);
    ...
    public static void initSmallVideo(Context context) {
        ...
        if (DeviceUtils.isZte()) {
            if (dcim.exists()) {
                VCamera.setVideoCachePath(dcim + "/Cain/");
            } else {
